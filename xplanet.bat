...
::
start /min xplanet.exe -lat 50.93106 -lon -5.33781 -label -config overlay_clouds -fontsize 18 -verb 3
...
:: Show the earth from a random planet or the moon and quit after drawing 
:: once.  The start /min minimizes the DOS window.
:: 
:: start /min xplanet.exe -fontsize 24 -label -target earth -origin system -radius 25 -north orbit -num_times 1 
